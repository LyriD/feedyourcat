...
class KittensControllerTest < ActionController::TestCase
  ...
  test "should create kitten" do
    assert_difference('Kitten.count') do
      post :create, kitten: { age: @kitten.age, male: @kitten.male, name: @kitten.name, weight: @kitten.weight }
    end
  ...
  test "should update kitten" do
    patch :update, id: @kitten, kitten: { age: @kitten.age, male: @kitten.male, name: @kitten.name, weight: @kitten.weight }
    assert_redirected_to kitten_path(assigns(:kitten))
  end
